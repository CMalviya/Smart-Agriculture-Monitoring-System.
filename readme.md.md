...
The system takes user inputs (acting as sensor readings) and provides useful crop-care recommendations.
...
## Project Objective
To demonstrate how simple programming can be applied to real-world agriculture problems through basic decision-making.
